class SessionsController < ApplicationController
  ...
  def create
    ...
    #registrated_user = RegistratedUser.find_by(email: form.email)
    #user_password_authentication = UserPasswordAuthentication.find_by(registrated_user: registrated_user)
